    ...
    'list': [
      {
        ...
        'scssValue': '0px 0px 8px rgba(100, 110, 144, 0.1)',
        'scene': '一级阴影'
      },
      {
        'name': '$shadow-2',
        ...
        'scssValue': '0px 0px 16px rgba(100, 110, 144, 0.2)',
        'scene': '二级阴影'
      },
      {
        'name': '$shadow-3',
        ...
        'scssValue': '0px 0px 40px rgba(0, 0, 0, 0.1)',
        'scene': '三级阴影'
      },
      {
  ...
  },
  {
    ...
    'list': [
      ...
      },
      {
        ...
        'type': 'string',
        'value': 'linear-gradient(to bottom, #fff, #ffedd9)',

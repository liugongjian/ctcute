...
<template>
  <div class="login">
    <div class="login-content">
      <img src="../../assets/images/login/cute-login.png" alt="" class="login-img" />
      <div class="login-desc">
        <h3 class="login-title">登录 Cute Design</h3>
        <h5 class="login-tip">模拟登录效果 非真实用户和登录</h5>
        <el-form ref="ruleForm" :rules="rules" :model="form">
          ...
          <el-form-item prop="verifyCode" class="login-code">
            ...
            <div class="login-code-svg" @click="refreshCode" v-html="codeUrl"></div>
          </el-form-item>
          ...
          <el-form-item>
            <el-button class="login-btn" type="primary" :loading="loading" @click="submitForm('ruleForm')">
              登 录
            </el-button>
          </el-form-item>
        </el-form>

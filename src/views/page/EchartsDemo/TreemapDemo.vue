...
const diskData = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        value: 36,
        name: 'GetValue of letiable.action',
        path: 'Automator/GetValue of letiable.action',
        children: [
          {
            value: 36,
            name: 'Contents',
            path: 'Automator/GetValue of letiable.action/Contents',
          },
        ],
      },
      {
      ...
      {
        value: 20,
        name: 'SetValue of letiable.action',
        path: 'Automator/SetValue of letiable.action',
        children: [
          {
            value: 20,
            name: 'Contents',
            path: 'Automator/SetValue of letiable.action/Contents',
          },
        ],
      },
      {
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            value: 24,
            name: 'letioPro.brailledriver',
            path: 'ScreenReader/BrailleDrivers/letioPro.brailledriver',
          },
          {
            value: 16,

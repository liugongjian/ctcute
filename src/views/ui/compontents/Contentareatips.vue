<template>
  <div class="sub-contentareatips">
    ...
    <el-row>
      <el-col :span="5">
        <el-alert title="这是一个普通提示" :closable="false"><span slot="icon-custom"><svg-icon class="el-alert__icon" name="info-circle"/></span></el-alert>
      </el-col>
      ...
      <el-col :span="5" :pull="3">
       <el-alert><span slot="icon-custom"><svg-icon class="el-alert__icon" name="question-circle"/></span></el-alert>
      </el-col>
    </el-row>
  </div>
</template>
